	...
	$(function(){
		...
		$("#cancelButton").click(function(){
			if(confirm("작성을 종료하시겠습니까?")){
				window.location.href="http://211.63.89.152/user/classDetail/detail.do?lcode="+$("#lcode").val();
			}//end if
		});
	});//ready
	$(function() {
...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="sub_area">
			<div class="stop_area">
				<h4><img src="//res.afreecatv.com/images/help/img_report.jpg" alt="1:1신고하기" /></h4>
			</div>
					...
					<tr class="t1">
						...
						<td>
							<select id="SELECT0" name="reportType" onchange="ChangeCategory0(this.options[this.selectedIndex].value);">
								...
								<option value="3">유해한 위험 콘텐츠</option>
								<option value="4">부적절한 홍보성 콘텐츠</option>
								<option value="5">정치적 성향이 강한 콘텐츠</option>
							</select>
						</td>
					</tr>
					<tr class="t3">
