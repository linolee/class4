...
<link rel="stylesheet" type="text/css" href="http://211.63.89.148:8080/team_prj3_class4/common/main_v190130.css">
...
<div id="wrap">
	...
	<c:forEach var="classList" items="${ classList }">
		<tr class=searchDetail>
			...
			<td class=tableBody>
				<a href="http://211.63.89.148:8080/team_prj3_class4/user/classDetail/detail.do?lcode=${classList.get(i).lcode }">
	...
	<c:forEach var="classStatusList" items="${ classStatusList }">
		<tr class=searchDetail>
			...
			<td class=tableBody>
				<a href="http://211.63.89.148:8080/team_prj3_class4/user/classDetail/detail.do?lcode=${classStatusList.get(i).lcode }">
