				...
				<div id="joinDiv">
					<div id="memberJoinInputDiv">
						...
						<ul>
							<li>
								<label>아이디</label><br>
								<input type="text" id="input_id" class="inputBox">
							</li>
							<li>
								<label>비밀번호</label><br>
								<input type="password" id="input_pass" class="inputBox">
							</li>
							<li>
								<label>비밀번호 재확인</label><br>
								<input type="password" id="input_pass2" class="inputBox">
							</li>
							<li>
								<label>이름</label><br> 
								<input type="text" id="input_name" class="inputBox">
							</li>
							<li>
								<label>생년월일</label><br>
								<input type="text" id="input_year" class="inputBox">년
								<select id="input_month" class="selectBox">
							...
							<li>
								<label>성별</label><br>
								<select id="input_gender" class="selectBox">
									<option>남자</option>
									<option>여자</option>
								</select>
							</li>
