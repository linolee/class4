	...
	<form action="login.do" method="post">
	  <div class="card-body text-center">
		<div class="input-group mb-3 col-lg-3 mx-auto">
		  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="아이디" name="id" >
		</div>
		<div class="input-group mb-3 col-lg-3 mx-auto">
		  <input type="password" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="비밀번호" name="pass" >
		</div>
	  </div>
