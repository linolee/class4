			...
			<table id="listTab" border="1">
				...
				<c:forEach var="List" items="${ requestScope.l_list }">
					...
					<tr class="class-list">
						...
						<td><a href="http://211.63.89.152/user/classDetail/detail.do?lcode=${List.lcode}" target="_blank"><input type="button" class="btn btn-warning" name="btnDetail" value="상세보기"></a></td>
					</tr>
