...
<script type="text/javascript">
 $(function(){
	$("#qnaBtn").click(function(){
		location.href="http://211.63.89.152/user/student/question.do?lcode="+$("[name='lcode']").val();	
	});
	$("#guestqnaBtn").click(function(){
		location.href="http://211.63.89.152/user/student/question.do?lcode="+$("[name='lcode']").val();	
	});
	$("#reportBtn").click(function(){
		location.href="http://211.63.89.152/user/student/report.do?lcode="+$("[name='lcode']").val();	
	});
	...
	function jjim(lcode){
		$.ajax({
			url : "http://211.63.89.152/user/student/jjimHeart.do",
			data : "lcode="+lcode,
			dataType : "text",
			type : "get",
			error : function( xhr ){
	...
	function classJoin(lcode){
		$.ajax({
			url : "http://211.63.89.152/user/student/classJoin.do",
			data : "lcode="+lcode,
			dataType : "text",
			type : "get",
			error : function( xhr ){
	...
	<div id="detailContent" style="clear:both; position:relative; width: 700px; float: left; margin: 10px;">
		<div id="detail">
			<div id="classTitleImg" style="height: 400px; top:20px; ">
				<!-- 대표이미지 -->
				<img style="width: 100%; height: 400px;" src="http://211.63.89.152/upload/lessonBanner/${summary.banner_img}">
			</div>
             ...
             <p class="c_summary">
            	...
            	<tr>
            		<td rowspan="4" style="width: 180px; height: 180px;">
            			<img style="width: 50px; height: 50px;" src="http://211.63.89.152/upload/teacher/${summary.img}">
            			<br/>
							...
							<div class="group" style="border-top: 1px solid #cfcfcf; margin-bottom: 15px; height: 250px;">
								...
								<div style="float: right; border-left: 1px solid #cfcfcf;width: 150px; height: 200px; text-align: center;">
									<div style="float:none;margin-top: 15px;margin-bottom:10px ; margin-left:39px;
										width: 50%; height: 40%;">
										<img style="width: 100%; height:100%;"src="http://211.63.89.152/upload/teacher/${summary.img}">
									</div>
								...
								<div style="cursor:pointer;width: 150px; height: 200px; float: left; margin: 7px;" onclick="location.href='http://211.63.89.152/user/classDetail/detail.do?lcode=${tclist.lcode}'">
									<div style="width: 150px; height: 100px;">
										<img style="width: 150px; height: 100px;" src="http://211.63.89.152/upload/teacher/${tclist.main_img}"/>
				  ...
				  <div class="box m_info">
	                  <div class="clear_fix" style="height: 50px;">
	                      <div class="pic" style="float: left;">
	                        <img style="width: 40px; height: 40px; margin-right: 10px;" src="http://211.63.89.152/upload/teacher/${summary.img}">
						  </div>
		...
		<div class="modal" id="modal" style="font-size: 20px;"> 
         <div class="modal-content"> 
             ...
             <img style="margin-left: 140px;" src="http://211.63.89.152/resources/img/logo.png"/>
