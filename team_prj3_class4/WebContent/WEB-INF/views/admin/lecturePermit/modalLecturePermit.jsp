	...
	<div id="detailContent" style="clear:both; position:relative; width: 700px; float: left; margin: 10px;">
		<div id="detail">
			<div id="classTitleImg" style="height: 400px;">
				...
				<!-- 대표이미지 -->
				<img style="width: 100%; height: 400px;" id="ls_bannerImg" onerror="this.src='http://211.63.89.148:8080/team_prj3_class4/upload/common/default.jpg'">
			</div>
            	...
            	<tr>
            		<td rowspan="4" style="width: 180px; height: 160px;">
            			<img style="width: 100px;height: 100px;padding-top: 0px;margin-top: 25px;margin-bottom: 10px;" 
            				id="ls_teacherImg" onerror="this.src='http://211.63.89.148:8080/team_prj3_class4/upload/common/default.jpg'">
            			<br/>
