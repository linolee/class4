	...
	var detailAddress="";
 	...
 	$.ajax({
		...
		success:function( json ){
			...
			/*  */
			var bannerImg="http://211.63.89.152/upload/common/default.jpg";
			var teacherImg="http://211.63.89.152/upload/common/default.jpg";
			if(null!=json.banner_img){
				bannerImg="http://211.63.89.152/upload/lessonBanner/"+json.banner_img;
			}
			
			if(null!=json.teacher_img){
				teacherImg="http://211.63.89.152/upload/teacher/"+json.teacher_img
			}
