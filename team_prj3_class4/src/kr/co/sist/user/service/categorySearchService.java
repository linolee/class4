...
import kr.co.sist.user.dao.categorySearchDAO;
...
public class categorySearchService {
	...
	@Autowired
	private categorySearchDAO cs_dao;
	
	public int totalCount(String keyword) {
		int cnt = 0;
		cnt = cs_dao.selectCategoryTotalCount(keyword);
		return cnt;
	}
	...
	public List<SearchClassList> searchClassList(SearchListVO slvo) {
		List<SearchClassList> list = cs_dao.selectCategoryClassList(slvo);
